 ...
 * Note: Device width has to be smaller than @min-width-breakpoint-tablet
 * defined in MinervaNeue skin.
 * Otherwise Mobile print styles won't be applied.
 * @type {Object}
 */
const MOBILE_DEVICE_VIEWPORT = puppeteer.KnownDevices['Galaxy S III'].viewport;
/**
